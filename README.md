...
1. Introduction
------------------------------------------------
Este programa fue desarrollado con motivos académicos, con el objetivo de describir los paradigmas de programación vigentes y como estos orientan la resolución de un problema.
